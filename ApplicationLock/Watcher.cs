...
namespace ApplicationLock
{
    public partial class Watcher : Form
    {
        ...
        private List<string> DeniedApplications = new List<string>() { "iexplore", "MicrosoftEdge" };
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                notifyIcon1.BalloonTipText = $"\"{proc.ProcessName}\" is not allowed in this computer";
